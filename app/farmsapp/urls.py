...
urlpatterns = [
    ...
    path('approve-activity-form/<str:activityFormID>/<str:activityDate>', views.approveActivityForm, name="approveActivityForm"),
    path('reject-activity-form/<str:activityFormID>/<str:activityDate>', views.rejectActivityForm, name="rejectActivityForm"),
