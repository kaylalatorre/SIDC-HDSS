 ...
 * Gets relevant values for biosec tables (i.e., biosecID, biosec fields) 
 * then passes to saveBiocheck()
 */

//  $(document).ready(function() {
//     $('#editbiocheck-btn').on("click", function(){

//         alert("LOG: in editBiocheck()!");
...
//         data: {"biosecID": biosecID, "checkArr": chArr}, // pass biosec id here
//         success: function (response){
